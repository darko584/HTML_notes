...
<head>
  ...
  <link rel="stylesheet" href="https://www.cyberpunk.net/build/css/1-6a6b2d81bd6cdb236129.css">
  <link rel="stylesheet" href="https://www.cyberpunk.net/build/css/home3-ff472a0c7997ed8875aa.css">
  ...
  <title>NightCity</title>
</head>

<body>
  <header class="head">
    <div class="bg">
      <video autoplay muted loop="loop" poster="" id="cp">

        <source src="trim_cp1.mp4" type="video/mp4">
      ...
      <div class="navsymbol">
        <a class="logo-link" href="#"><img src="https://en.cdprojektred.com/wp-content/themes/evp-cdpr/img/cdpr-logo-horizontal-white.png" alt="CD PROJECKT RED"></a>
      </div>
    </div>
  </header>
  <div class="page2">
  ...
  <footer class="footer-content">
    ...
    <div class="I-content">
      ...
      <ul class="footer-top-nav">
        <li class="footer-top-nav-content-1">
        ...
        <li>
          <span class="footer-nav-for-social">Find us on</span>
        </li>
        <li class="socailfooter">
          <div>
            <a href="https://www.facebook.com/CyberpunkGame" target="_blank">FB
        ...
        <li class="socailfooter">
          <div>
            <a href="https://www.youtube.com/user/CyberPunkGame" target="_blank">YT
        ...
        <li class="socailfooter">
          <div>
            <a href="http://twitter.com/cyberpunkgame" target="_blank">TW
        ...
        <li class="socailfooter">
          <div>
            <a href="https://discord.gg/cyberpunkgame" target="_blank">DIS
              <i class="logo logo-discord"></i>
            </a>
          </div>
        </li>
        <li class="socailfooter">
          <div>
            <a href="https://www.instagram.com/cyberpunkgame/" target="_blank">INS
              <i class="logo logo-instagram"></i>
            </a>
          </div>
        </li>
        <li class="socailfooter">
          <div>
            <a href="https://cyberpunkgame.tumblr.com/" target="_blank">TMBLR
        ...
        <li class="socailfooter">
          <div>
            <a href="https://www.twitch.tv/cdprojektred" target="_blank">TW
